...
import torch
from roboverse.evals.lenewton.eval import eval, get_evaluation_tasks  # noqa

from rv_train.train import get_pretrained_model


def main():
    parser = argparse.ArgumentParser(description="Evaluate model on LENEWTON environment")
    parser.add_argument(
